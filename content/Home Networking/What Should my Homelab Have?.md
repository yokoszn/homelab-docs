---
title: What Should my Homelab Have?
---
...
5. Use passphrases when able. Example: 1DeerCloudSubmarine91* [XKCD Password Generator](https://xkpasswd.net/s/).
6. 
...
your homelab could be a Lenovo T450 with 4 CPU Cores 8gb Ram and 128GB of Storage. 
theres lots of old hardware that may not be capable of running a modern desktop experience (think Windows 11 Bloat)

but can be perfectly capable little machines for any number of tasks.

Show Lenovo M700 tiny
i5-7500t 24gb ram 256gb ssd
...
Avoid Directly Exposing Ports, Ideally Use a VPN. if you must, implementing a DMZ (De-militarized Zone) [[Reverse Proxy]], Cloudflare Tunnel, etc.
Use VPN Wireguard/OpenVPN or Pangolin (Newt Tunnel)
